var linkify = (function (e) {
    ...
    ((g.groups = {}),
        (g.prototype = {
            ...
            ta(e, t, n, i) {
                for (let s = 0; s < e.length; s++) this.tt(e[s], t, n, i);
            },
            tr(e, t, n, i) {
                let s;
                return (
                    (i = i || g.groups),
                    t && t.j ? (s = t) : ((s = new g(t)), n && i && _(t, n, i)),
                    this.jr.push([e, s]),
                    s
                );
            },
            ts(e, t, n, i) {
                ...
                const r = e.length;
                if (!r) return s;
                for (let t = 0; t < r - 1; t++) s = s.tt(e[t]);
                return s.tt(e[r - 1], t, n, i);
            },
            tt(e, n, i, s) {
                s = s || g.groups;
                const r = this;
                if (n && n.j) return ((r.j[e] = n), n);
                const o = n;
                let a,
                    l = r.go(e);
                if (
    ...
    const d = (e, t, n, i, s) => e.ta(t, n, i, s),
        h = (e, t, n, i, s) => e.tr(t, n, i, s),
        f = (e, t, n, i, s) => e.ts(t, n, i, s),
        p = (e, t, n, i, s) => e.tt(t, n, i, s),
        m = "WORD",
        y = "UWORD",
        k = "LOCALHOST",
        b = "TLD",
    ...
    function pe(e, t, n, i, s) {
        ...
        for (let n = 0; n < o - 1; n++) {
            ...
            (e.j[o]
                ? (r = e.j[o])
                : ((r = new g(i)), (r.jr = s.slice()), (e.j[o] = r)),
                (e = r));
        }
        return ((r = new g(n)), (r.jr = s.slice()), (e.j[t[o - 1]] = r), r);
    }
    function me(e) {
        const t = [],
            n = [];
        ...
        for (; i < e.length; ) {
            let s = 0;
            for (; "0123456789".indexOf(e[i + s]) >= 0; ) s++;
            if (s > 0) {
                t.push(n.join(""));
                let r = parseInt(e.substring(i, i + s), 10);
                for (; r > 0; r--) n.pop();
                i += s;
            } else
                "_" === e[i] ? (t.push(n.join("")), i++) : (n.push(e[i]), i++);
        }
        return t;
    }
    const ye = {
    ...
    function ke(e, n) {
        void 0 === n && (n = null);
        let i = t({}, ye);
        e && (i = t(i, e instanceof ke ? e.o : e));
        const s = i.ignoreTags,
            r = [];
        for (let e = 0; e < s.length; e++) r.push(s[e].toUpperCase());
        ((this.o = i), n && (this.defaultRender = n), (this.ignoreTags = r));
    }
    function be(e) {
        return e;
    }
    ke.prototype = {
        ...
        get(e, t, n) {
            ...
            return s
                ? ("object" == typeof s
                      ? ((s = n.t in s ? s[n.t] : ye[e]),
                        "function" == typeof s && i && (s = s(t, n)))
                      : "function" == typeof s && i && (s = s(t, n.t, n)),
                  s)
                : s;
        },
        getObj(e, t, n) {
            let i = this.o[e];
            return (
                "function" == typeof i && null != t && (i = i(t, n.t, n)),
                i
            );
        },
        render(e) {
    ...
    function we(e, t) {
        ...
        for (const e in t) n.prototype[e] = t[e];
        return ((n.t = e), n);
    }
    ve.prototype = {
        isLink: !1,
        ...
        render(e) {
            const n = this,
                i = this.toFormattedHref(e),
                s = e.get("tagName", i, n),
                r = this.toFormattedString(e),
                o = {},
                a = e.get("className", i, n),
                l = e.get("target", i, n),
                u = e.get("rel", i, n),
                c = e.getObj("attributes", i, n),
                _ = e.getObj("events", i, n);
            return (
                (o.href = i),
                a && (o.class = a),
                l && (o.target = l),
                u && (o.rel = u),
                c && t(o, c),
                { tagName: s, attributes: o, content: r, eventListeners: _ }
            );
        },
    };
    const Oe = we("email", {
        ...
        Ae = we("url", {
            ...
            hasProtocol() {
                const e = this.tk;
                return e.length >= 2 && e[0].t !== k && e[1].t === U;
            },
        });
    ...
    function Ne() {
        ze.scanner = (function (e) {
            ...
            (null == de &&
                ...
                p(c, "_", ie),
                p(c, "\\", M));
            const d = h(c, ce, O, { [n]: !0 });
            h(d, ce, d);
            const ge = h(c, ae, m, { [i]: !0 });
            h(ge, ae, ge);
            const fe = h(c, le, y, { [s]: !0 });
            (h(fe, ae), h(fe, le, fe));
            const ye = h(c, _e, "WS", { [u]: !0 });
            (p(c, "\n", j, { [u]: !0 }), p(ye, "\n"), h(ye, _e, ye));
            const ke = h(c, ue, se, { [l]: !0 });
            (h(ke, ue, ke), p(ke, "️", ke));
            const be = p(ke, "‍");
            h(be, ue, ke);
            const Ee = [[ae, ge]],
                ve = [
            ...
            for (let e = 0; e < de.length; e++) pe(c, de[e], b, m, Ee);
            for (let e = 0; e < he.length; e++) pe(c, he[e], E, y, ve);
            (_(b, { tld: !0, ascii: !0 }, o),
                _(E, { utld: !0, alpha: !0 }, o),
                pe(c, "file", v, m, Ee),
                pe(c, "mailto", v, m, Ee),
                pe(c, "http", w, m, Ee),
                pe(c, "https", w, m, Ee),
                pe(c, "ftp", w, m, Ee),
                pe(c, "ftps", w, m, Ee),
                _(v, { scheme: !0, ascii: !0 }, o),
                _(w, { slashscheme: !0, ascii: !0 }, o),
                (e = e.sort((e, t) => (e[0] > t[0] ? 1 : -1))));
            for (let t = 0; t < e.length; t++) {
                const s = e[t][0],
                    o = e[t][1] ? { scheme: !0 } : { slashscheme: !0 };
                (s.indexOf("-") >= 0
                    ? (o[a] = !0)
                    : ae.test(s)
                      ? ce.test(s)
            ...
            return (
                f(c, "localhost", k, { ascii: !0 }),
                (c.jd = new g(re)),
                { start: c, tokens: t({ groups: o }, oe) }
            );
        })(ze.customSchemes);
        for (let e = 0; e < ze.tokenQueue.length; e++)
            ze.tokenQueue[e][1]({ scanner: ze.scanner });
        ze.parser = (function (e) {
            let { groups: t } = e;
            const n = t.domain.concat([
                ...
                i = [P, R, x, T, z, U, B, $, F, L, S, A, C, V, Z, ee],
                s = [
                    N,
                    P,
                    I,
            ...
            (d(r, t.domain, a),
                ...
                d(a, t.domain, a));
            const c = p(a, H);
            (p(o, H, c), p(l, H, c), p(u, H, c));
            const _ = p(o, $);
            (d(_, s, o), d(_, t.domain, o));
            const g = Ce();
            (d(c, t.domain, g), d(g, t.domain, g));
            const h = p(g, $);
            d(h, t.domain, g);
            const f = Ce(Oe);
            (d(h, t.tld, f), d(h, t.utld, f), p(c, k, f));
            const m = p(g, W);
            (d(m, t.domain, g), d(f, t.domain, g), p(f, $, h), p(f, W, m));
            const y = p(f, U);
            d(y, t.numeric, Oe);
            const b = p(a, W),
                E = p(a, $);
            (d(b, t.domain, a), d(E, s, o), d(E, t.domain, a));
            const v = Ce(Ae);
            (d(E, t.tld, v),
                d(E, t.utld, v),
                d(v, t.domain, a),
            ...
            const pe = Ce(Ae),
                ...
                ye = Ce(Ae),
                ke = Ce(Ae);
            (d(ge, n, pe), d(de, n, me), d(he, n, ye), d(fe, n, ke));
            const be = Ce(),
                Ee = Ce(),
                ve = Ce(),
                we = Ce();
        ...
        for (let e = 0; e < ze.pluginQueue.length; e++)
            ze.pluginQueue[e][1]({ scanner: ze.scanner, parser: ze.parser });
        ze.initialized = !0;
    }
    function Pe(e) {
        return (
            ...
            (function (e, t, n) {
                ...
                for (; s < i; ) {
                    ...
                    for (; s < i && (u = l || a.go(n[s].t)); )
                        ((l = null),
                            (a = u),
                            a.accepts() ? ((g = 0), (_ = a)) : g >= 0 && g++,
                            s++,
                            c++);
                    if (g < 0) ((s -= c), s < i && (o.push(n[s]), s++));
                    else {
                        (o.length > 0 && (r.push(xe(je, t, o)), (o = [])),
                            (s -= g),
                            (c -= g));
                        const e = _.t,
                            i = n.slice(s - c, s);
                ...
                return (o.length > 0 && r.push(xe(je, t, o)), r);
            })(
                ze.parser.start,
                e,
                (function (e, t) {
                    const n = fe(t.replace(/[A-Z]/g, e => e.toLowerCase())),
                        i = n.length,
                        s = [];
                    let r = 0,
                        o = 0;
    ...
    return (
        ...
        (e.find = function (e, t, n) {
            if (
                ...
                if (n)
                    throw Error(
                        `linkifyjs: Invalid link type ${t}; must be a string`,
                    );
                ((n = t), (t = null));
            }
            const i = new ke(n),
            ...
            for (let e = 0; e < s.length; e++) {
                const n = s[e];
                !n.isLink || (t && n.t !== t) || r.push(n.toFormattedObject(i));
            }
            return r;
        }),
        (e.init = Ne),
        ...
        (e.options = Ee),
        (e.regexp = ge),
        (e.registerCustomProtocol = function (e, t) {
            if (
                (void 0 === t && (t = !1),
                ze.initialized &&
                    Te(
                        `linkifyjs: already initialized - will not register custom scheme "${e}" ${Re}`,
                    ),
            ...
            ze.customSchemes.push([e, t]);
        }),
        (e.registerPlugin = function (e, t) {
            if ("function" != typeof t)
                throw new Error(
                    `linkifyjs: Invalid plugin ${t} (expects function)`,
                );
            for (let n = 0; n < ze.pluginQueue.length; n++)
                if (e === ze.pluginQueue[n][0])
                    return (
                        Te(
                            `linkifyjs: plugin "${e}" already registered - will be overwritten`,
                        ),
                        void (ze.pluginQueue[n] = [e, t])
                    );
            (ze.pluginQueue.push([e, t]),
                ze.initialized &&
                    Te(
                        `linkifyjs: already initialized - will not register plugin "${e}" ${Re}`,
                    ));
        }),
        (e.registerTokenPlugin = function (e, t) {
            if ("function" != typeof t)
                throw new Error(
                    `linkifyjs: Invalid token plugin ${t} (expects function)`,
                );
            for (let n = 0; n < ze.tokenQueue.length; n++)
                if (e === ze.tokenQueue[n][0])
                    return (
                        Te(
                            `linkifyjs: token plugin "${e}" already registered - will be overwritten`,
                        ),
                        void (ze.tokenQueue[n] = [e, t])
                    );
            (ze.tokenQueue.push([e, t]),
                ze.initialized &&
                    Te(
                        `linkifyjs: already initialized - will not register token plugin "${e}" ${Re}`,
                    ));
        }),
        (e.reset = function () {
            ((g.groups = {}),
